import {
  ...
  m as Wt,
  n as Zt,
} from "./WebCryptoP256-Bp2Ccc3u.js";
import {
  E as zt,
  F as Vt,
  a as Jt,
...
const rn = "@base-org/account",
  sn = "1.1.1",
  ot = { name: rn, version: sn },
  on = "https://keys.coinbase.com/connect",
  ct = "https://rpc.wallet.coinbase.com",
  ce = ot.name,
  V = ot.version,
  cn = () => ({ chains: [] }),
  un = () => ({ keys: {} }),
  dn = () => ({ account: {} }),
  ln = () => ({ subAccount: void 0 }),
  pn = () => ({ subAccountConfig: {} }),
  mn = () => ({ spendPermissions: [] }),
  fn = () => ({ config: { version: V } }),
  E = Se(
        ...
        Object.assign(
          Object.assign(
            Object.assign(
              Object.assign(
                Object.assign(
                  Object.assign(Object.assign({}, cn(...e)), un(...e)),
                  dn(...e)
                ),
                ln(...e)
              ),
  ...
  p = Object.assign(Object.assign({}, E), kn),
  An =
  ...
  xn = () => {
    ...
    if (typeof window < "u") {
      const a =
        (n =
          (e = p.config.get().deviceId) !== null && e !== void 0
            ? e
      ...
      if (window.ClientAnalytics) {
        ...
        r({
          ...
          i({ deviceId: a }),
          p.config.set({ deviceId: a });
      }
    }
  },
  En = "0xba5ed110efdba3d005bfc882d75358acbbb85842",
  dt = "0xf85210B21cC50302F477BA56686d2019dC9b67Ad",
  N = [
  ...
  pt = "Unspecified error message.",
  Cn = "Unspecified server error.";
function Te(e, t = pt) {
  if (e && Number.isInteger(e)) {
    const n = e.toString();
    if (ve(be, n)) return be[n].message;
    if (mt(e)) return Cn;
  }
  return t;
}
...
function In(e, { shouldIncludeStack: t = !1 } = {}) {
  const n = {};
  if (
    e &&
    typeof e == "object" &&
    ...
    const a = e;
    (n.code = a.code),
      a.message && typeof a.message == "string"
        ? ((n.message = a.message), ve(a, "data") && (n.data = a.data))
        : ((n.message = Te(n.code)), (n.data = { originalError: Fe(e) }));
  } else
    (n.code = x.rpc.internal),
      (n.message = qe(e, "message") ? e.message : pt),
      (n.data = { originalError: Fe(e) });
  return t && (n.stack = qe(e, "stack") ? e.stack : void 0), n;
}
function mt(e) {
...
const m = {
  rpc: {
    parse: (e) => j(x.rpc.parse, e),
    invalidRequest: (e) => j(x.rpc.invalidRequest, e),
    invalidParams: (e) => j(x.rpc.invalidParams, e),
    methodNotFound: (e) => j(x.rpc.methodNotFound, e),
    internal: (e) => j(x.rpc.internal, e),
    server: (e) => {
    ...
    invalidInput: (e) => j(x.rpc.invalidInput, e),
    resourceNotFound: (e) => j(x.rpc.resourceNotFound, e),
    resourceUnavailable: (e) => j(x.rpc.resourceUnavailable, e),
    transactionRejected: (e) => j(x.rpc.transactionRejected, e),
    methodNotSupported: (e) => j(x.rpc.methodNotSupported, e),
    limitExceeded: (e) => j(x.rpc.limitExceeded, e),
  },
  provider: {
    userRejectedRequest: (e) => H(x.provider.userRejectedRequest, e),
    unauthorized: (e) => H(x.provider.unauthorized, e),
    unsupportedMethod: (e) => H(x.provider.unsupportedMethod, e),
    disconnected: (e) => H(x.provider.disconnected, e),
    chainDisconnected: (e) => H(x.provider.chainDisconnected, e),
    unsupportedChain: (e) => H(x.provider.unsupportedChain, e),
    custom: (e) => {
      if (!e || typeof e != "object" || Array.isArray(e))
        throw new Error(
...
function j(e, t) {
  const [n, a] = ft(t);
  return new Ie(e, n || Te(e), a);
}
function H(e, t) {
  const [n, a] = ft(t);
  return new ht(e, n || Te(e), a);
}
function ft(e) {
  if (e) {
...
function On(e) {
  try {
    ...
    return new Ie(t.code, t.message, t.data);
  } catch {
    return null;
  }
}
function R(e, t, n) {
  if (e == null)
    throw (
      t ?? m.rpc.invalidParams({ message: "value must be present", data: e })
    );
}
function U(e, t) {
  if (!Array.isArray(e))
...
const jn = `Base Account SDK requires the Cross-Origin-Opener-Policy header to not be set to 'same-origin'. This is to ensure that the SDK can communicate with the Base Account app.
...
Please see https://docs.base.org/smart-wallet/quickstart#cross-origin-opener-policy for more information.`,
    ...
    return {
      ...
      checkCrossOriginOpenerPolicy: async () => {
        ...
        try {
          ...
          const a = n.headers.get("Cross-Origin-Opener-Policy");
          (e = a ?? "null"), e === "same-origin" && console.error(jn);
        } catch (t) {
          console.error(
  ...
  { checkCrossOriginOpenerPolicy: Nn, getCrossOriginOpenerPolicy: Mn } = Rn();
function Un(e) {
  if (e) {
    if (
      e.attribution &&
    ...
    ((a = window.ClientAnalytics) === null ||
      ...
      a.logEvent(
        ...
        Object.assign(Object.assign({}, t), {
          ...
          appName:
            (i =
              (r = p.config.get().metadata) === null || r === void 0
                ? void 0
                : r.appName) !== null && i !== void 0
              ? i
              : "",
...
const Bn = () => {
    A(
      ...
      { action: w.unknown, componentType: y.unknown },
      k.high
    );
  },
  Kn = () => {
  ...
  Pe = ({ dialogContext: e }) => {
    A(
      `dialog.${e}.shown`,
      { action: w.render, componentType: y.modal, dialogContext: e },
      k.high
    );
  },
  bt = ({ dialogContext: e }) => {
    A(
      `dialog.${e}.dismissed`,
      { action: w.dismiss, componentType: y.modal, dialogContext: e },
      k.high
    );
  },
...
`,
  Ze = "BaseSans-Regular";
function Fn() {
  if (document.head.querySelector(`style[base-sdk-font="${Ze}"]`)) return;
  const t = document.createElement("style");
  t.setAttribute("base-sdk-font", Ze),
    (t.textContent = Ln),
...
function S(e, t, n, a, r, i) {
  ...
  if (typeof e == "function" && (o = e.defaultProps))
    for (c in o) s[c] === void 0 && (s[c] = o[c]);
  return Ne.vnode && Ne.vnode(u), u;
}
function vt(e) {
  var t,
    n,
  ...
  if (typeof e == "string" || typeof e == "number") a += e;
    ...
    if (Array.isArray(e))
      for (t = 0; t < e.length; t++)
        e[t] && (n = vt(e[t])) && (a && (a += " "), (a += n));
    else for (t in e) e[t] && (a && (a += " "), (a += t));
  return a;
}
function ye() {
  for (var e, t, n = 0, a = ""; n < arguments.length; )
    (e = arguments[n++]) && (t = vt(e)) && (a && (a += " "), (a += t));
  return a;
}
async function Hn(e) {
  return Wn(e);
...
const Zn = "#FFF",
  ...
  Qn =
    "data:image/svg+xml;base64,";
function yt() {
...
const Yn = () => {
  ...
  return (
    ...
    e ? S("div", { class: "-base-acc-sdk-dialog-handle-bar" }) : null
  );
};
class Xn {
  constructor() {
  ...
  clear() {
    this.items.clear(), this.root && Me(null, this.root);
  }
  render() {
    this.root &&
      Me(
        S("div", {
          children: S(Gn, {
            children: Array.from(this.items.entries()).map(([t, n]) =>
              Mt(
                _n,
                Object.assign({}, n, {
                  key: t,
                  handleClose: () => {
                    var a;
                    this.clear(),
                      (a = n.onClose) === null || a === void 0 || a.call(n);
                  },
                })
              )
            ),
...
const Gn = (e) => {
    const [t, n] = D(0),
      ...
      s = (f) => {
        if (!a) return;
        const l = f.touches[0].clientY - i;
        l > 0 && (n(l), f.preventDefault());
      },
      u = () => {
        if (a)
          if ((r(!1), t > 100)) {
    ...
    return S("div", {
      class: ye("-base-acc-sdk-dialog-container"),
      children: [
        S("style", { children: Jn }),
        S("div", {
          ...
          children: S("div", {
            ...
            style: {
              ...
              transition: a ? "none" : "transform 0.2s ease-out",
            },
            children: [S(Yn, {}), e.children],
          }),
        }),
      ],
    });
  },
  _n = ({ title: e, message: t, actionItems: n, handleClose: a }) => {
    const [r, i] = D(!0),
      [o, c] = D(!0),
      [s, u] = D(null);
    he(() => {
      ...
      he(() => {
        (async () => {
          var d;
          const g =
            (d = p.account.get().accounts) === null || d === void 0
              ? void 0
              : d[0];
          if (g) {
            const b = await Hn(g);
    ...
    const f = Ut(() => (s ? `Signed in as ${s}` : "Base Account"), [s]),
      h = !o;
    return S("div", {
      class: ye(
        "-base-acc-sdk-dialog-instance",
        r && "-base-acc-sdk-dialog-instance-hidden"
      ),
      children: [
        S("div", {
...
const ze = 420,
  Ve = 700,
  $n = "{app} wants to continue in Base Account",
  ea = "This action requires your permission to open a new window.";
function ta(e) {
  const t = (window.innerWidth - ze) / 2 + window.screenX,
    n = (window.innerHeight - Ve) / 2 + window.screenY;
  aa(e);
  function a() {
    const i = `wallet_${crypto.randomUUID()}`,
      o = window.open(e, i, `width=${ze}, height=${Ve}, left=${t}, top=${n}`);
    return o?.focus(), o || null;
  }
  const r = a();
  return r ? Promise.resolve(r) : ra(a);
}
function na(e) {
  e && !e.closed && e.close();
}
function aa(e) {
  ...
  for (const [n, a] of Object.entries(t))
    e.searchParams.has(n) || e.searchParams.append(n, a.toString());
}
function ra(e) {
  var t, n;
  const a =
      (n =
        (t = p.config.get().metadata) === null || t === void 0
          ? void 0
          : t.appName) !== null && n !== void 0
        ? n
        : "App",
    r = Oe();
  return new Promise((i, o) => {
    Pe({ dialogContext: "popup_blocked" }),
      r.presentItem({
        title: $n.replace("{app}", a),
        message: ea,
        onClose: () => {
          L({ dialogContext: "popup_blocked", dialogAction: "cancel" }),
            o(m.rpc.internal("Popup window was blocked"));
        },
        actionItems: [
          {
            text: "Try again",
            ...
            onClick: () => {
              ...
              const c = e();
              c ? i(c) : o(m.rpc.internal("Popup window was blocked")),
                r.clear();
            },
          },
          {
...
class ia {
  constructor({ url: t = on, metadata: n, preference: a }) {
    (this.popup = null),
      ...
      (this.postRequestAndWaitForResponse = async (r) => {
        const i = this.onMessage(({ requestId: o }) => o === r.id);
...
function sa(e) {
  const t = In(ca(e), { shouldIncludeStack: !0 }),
    n = new URL("https://docs.cloud.coinbase.com/wallet-sdk/docs/errors");
  return (
    n.searchParams.set("version", V),
...
function ca(e) {
  var t;
  if (typeof e == "string") return { message: e, code: x.rpc.internal };
  if (oa(e)) {
    const n = e.errorMessage,
      a =
        (t = e.errorCode) !== null && t !== void 0
          ...
          ? x.provider.userRejectedRequest
          : void 0;
...
class ua extends zt {}
const da = ({ method: e, correlationId: t }) => {
    A(
      "provider.request.started",
      {
        action: w.unknown,
        componentType: y.unknown,
        method: e,
  ...
  la = ({ method: e, correlationId: t, errorMessage: n }) => {
    A(
...
function kt(e) {
  return se(`0x${BigInt(e).toString(16)}`);
}
function ba(e) {
  return e.startsWith("0x") || e.startsWith("0X");
}
function At(e) {
  return ba(e) ? e.slice(2) : e;
}
function va(e) {
...
function we(e, t = !1) {
  if (typeof e == "string") {
    const n = At(e).toLowerCase();
    if (wt.test(n)) return se(t ? `0x${n}` : n);
  }
  throw m.rpc.invalidParams(`"${String(e)}" is not a hexadecimal string`);
}
function ya(e, t = !1) {
  let n = we(e, !1);
  return n.length % 2 === 1 && (n = se(`0${n}`)), t ? se(`0x${n}`) : n;
}
function wa(e) {
  if (typeof e == "number" && Number.isInteger(e)) return pe(e);
  if (typeof e == "string") {
    if (fa.test(e)) return pe(Number(e));
    if (va(e)) return pe(Number(BigInt(ya(e, !0))));
  }
  throw m.rpc.invalidParams(`Not an integer: ${String(e)}`);
}
const ka = ({ method: e, correlationId: t }) => {
    var n;
    A(
      "scw_signer.handshake.started",
      {
        ...
        enableAutoSubAccounts:
          (n = p.subAccountsConfig.get()) === null || n === void 0
            ? void 0
  ...
  Aa = ({ method: e, correlationId: t, errorMessage: n }) => {
    var a;
    A(
      "scw_signer.handshake.error",
      {
        ...
        errorMessage: n,
        enableAutoSubAccounts:
          (a = p.subAccountsConfig.get()) === null || a === void 0
            ? void 0
  ...
  Ea = ({ method: e, correlationId: t, errorMessage: n }) => {
    var a;
    A(
  ...
  Pa = ({ method: e, correlationId: t, errorMessage: n }) => {
    var a;
    A(
  ...
  Ra = ({ method: e, correlationId: t, errorMessage: n }) => {
    var a;
    A(
  ...
  Ua = ({ method: e, correlationId: t, errorMessage: n }) => {
    var a;
    A(
  ...
  J = (e) => ("message" in e && typeof e.message == "string" ? e.message : ""),
  St = Se(() => ({}));
function Je(e) {
  e.forEach((t) => {
    var n, a, r, i, o, c, s, u;
        ...
        name:
          (a =
            (n = t.nativeCurrency) === null || n === void 0
              ? void 0
              : n.name) !== null && a !== void 0
            ? a
            : "",
        nativeCurrency: {
          name:
            (i =
              (r = t.nativeCurrency) === null || r === void 0
                ? void 0
                : r.name) !== null && i !== void 0
              ? i
              : "",
          symbol:
            (c =
              (o = t.nativeCurrency) === null || o === void 0
                ? void 0
                : o.symbol) !== null && c !== void 0
              ? c
              : "",
          decimals:
            (u =
              (s = t.nativeCurrency) === null || s === void 0
                ? void 0
                : s.decimal) !== null && u !== void 0
              ? u
              : 18,
        },
      }),
      h = Jt({ chain: f, transport: Ue(t.rpcUrl) }),
      l = Bt({ client: h, transport: Ue(t.rpcUrl) });
    St.setState({ [t.id]: { client: h, bundlerClient: l } });
  });
}
function xt(e) {
  var t;
  return (t = St.getState()[e]) === null || t === void 0 ? void 0 : t.client;
}
const G = Se(() => ({ correlationIds: new Map() })),
  M = {
    get: (e) => G.getState().correlationIds.get(e),
    set: (e, t) => {
      G.setState((n) => {
        const a = new Map(n.correlationIds);
        return a.set(e, t), { correlationIds: a };
      });
    },
    delete: (e) => {
      G.setState((t) => {
    ...
    clear: () => {
      G.setState({ correlationIds: new Map() });
    },
  };
function _(e) {
  if (typeof e != "object" || e === null)
    throw m.rpc.internal("sub account info is not an object");
  if (!("address" in e)) throw m.rpc.internal("sub account is invalid");
  if ("address" in e && typeof e.address == "string" && !ie(e.address))
    throw m.rpc.internal("sub account address is invalid");
  if ("factory" in e && typeof e.factory == "string" && !ie(e.factory))
    throw m.rpc.internal("sub account factory address is invalid");
  if (
    "factoryData" in e &&
    typeof e.factoryData == "string" &&
    !W(e.factoryData)
  )
    throw m.rpc.internal("sub account factory data is invalid");
}
async function Ba() {
...
async function Da(e, t) {
  ...
  return { iv: n, cipherText: a };
}
async function La(e, { iv: t, cipherText: n }) {
  const a = await crypto.subtle.decrypt({ name: "AES-GCM", iv: t }, e, n);
...
async function Ct(e, t) {
  const n = Et(e),
    a = await crypto.subtle.exportKey(n, t);
  return ha(new Uint8Array(a));
}
...
async function qa(e, t) {
  return JSON.parse(await La(t, e));
}
  ...
  const n = Object.assign(Object.assign({}, e), {
    ...
    a = await window.fetch(t, {
      ...
      headers: {
        ...
        "X-Cbw-Sdk-Version": V,
        "X-Cbw-Sdk-Platform": ce,
      },
    }),
    { result: r, error: i } = await a.json();
  if (i) throw i;
  return r;
}
function Ha(e) {
...
function It(e, t) {
  ...
  const a = ue(n);
  return (r, i) => a.then((o) => i(o.transaction(t, r).objectStore(t)));
}
let me;
function je() {
  return me || (me = It("keyval-store", "keyval")), me;
}
function Wa(e, t = je()) {
  return t("readonly", (n) => ue(n.get(e)));
}
function Za(e, t, n = je()) {
  return n("readwrite", (a) => (a.put(t, e), ue(a.transaction)));
}
function za(e, t = je()) {
  return t("readwrite", (n) => (n.delete(e), ue(n.transaction)));
}
function Va(e, t) {
  const n = typeof indexedDB < "u" ? It(e, t) : void 0;
  return {
    getItem: async (a) => {
      const r = await Wa(a, n);
      return r || null;
    },
    removeItem: async (a) => za(a, n),
    setItem: async (a, r) => Za(a, r, n),
  };
}
const Ja = "base-acc-sdk",
  Qa = "keys",
  Re = "activeId",
  z = Va(Ja, Qa);
async function Ya() {
  const e = await Ft({ extractable: !1 }),
    t = xe(Ee(e.publicKey), 1);
  return await z.setItem(t, e), await z.setItem(Re, t), e;
}
async function Xa() {
  const e = await z.getItem(Re);
  if (!e) return null;
  const t = await z.getItem(e);
  return t || null;
}
async function Ga() {
  const e = await Xa();
  if (!e) {
    const t = await Ya(),
      n = xe(Ee(t.publicKey), 1);
    return await z.setItem(n, t), await z.setItem(Re, n), t;
  }
  return e;
}
async function _a() {
  const e = await Ga(),
    t = xe(Ee(e.publicKey), 1),
    n = async (a) => {
      const { payload: r, metadata: i } = Kt({
          challenge: a,
          origin: "https://keys.coinbase.com",
          userVerification: "preferred",
        }),
        o = await Dt({ payload: r, privateKey: e.privateKey });
      return { signature: Lt(o), raw: {}, webauthn: i };
    };
  return {
    id: t,
    publicKey: t,
    ...
    async signMessage({ message: a }) {
      return n(tt(a));
    },
    async signTypedData(a) {
      return n(Ce(a));
    },
    type: "webAuthn",
  };
...
async function ke() {
  return { account: await _a() };
}
const Qe = { storageKey: "ownPrivateKey", keyType: "private" },
  Ye = { storageKey: "ownPublicKey", keyType: "public" },
  Xe = { storageKey: "peerPublicKey", keyType: "public" };
class $a {
  constructor() {
  ...
  async generateKeyPair() {
    ...
    (this.ownPrivateKey = t.privateKey),
      ...
      await this.storeKey(Qe, t.privateKey),
      await this.storeKey(Ye, t.publicKey);
  }
  async loadKeysIfNeeded() {
    if (
      (this.ownPrivateKey === null &&
        (this.ownPrivateKey = await this.loadKey(Qe)),
      this.ownPublicKey === null &&
        (this.ownPublicKey = await this.loadKey(Ye)),
      (this.ownPrivateKey === null || this.ownPublicKey === null) &&
        (await this.generateKeyPair()),
      this.peerPublicKey === null &&
        (this.peerPublicKey = await this.loadKey(Xe)),
      this.sharedSecret === null)
    ) {
      if (this.ownPrivateKey === null || this.peerPublicKey === null) return;
      this.sharedSecret = await Ka(this.ownPrivateKey, this.peerPublicKey);
    }
  }
  async loadKey(t) {
    const n = p.keys.get(t.storageKey);
    return n ? Tt(t.keyType, n) : null;
  }
  async storeKey(t, n) {
    const a = await Ct(t.keyType, n);
    p.keys.set(t.storageKey, a);
  }
}
function Y(e, t) {
  if (!(typeof e != "object" || e === null))
    return t
      ...
      .filter(Boolean)
      .reduce((n, a) => {
        if (typeof n == "object" && n !== null) return n[a];
      }, e);
}
function Ge(e) {
  var t;
...
function er(e, t) {
  if (!Array.isArray(e.params)) throw m.rpc.invalidParams();
  const n = [...e.params];
  switch (e.method) {
    case "eth_signTransaction":
    case "eth_sendTransaction":
...
function tr(e) {
  if (
    ...
    throw m.rpc.invalidParams();
  if (e.length === 2) {
    if (!Array.isArray(e[1])) throw m.rpc.invalidParams();
    for (const t of e[1])
...
function oe(e, t) {
  ...
  if (t && e.method.startsWith("wallet_")) {
    let a = Y(n, "params.0.capabilities");
...
async function Ae() {
  var e;
  const t = (e = p.subAccountsConfig.get()) !== null && e !== void 0 ? e : {},
    n = {};
  if (t.enableAutoSubAccounts) {
    const { account: a } = t.toOwnerAccount
      ? await t.toOwnerAccount()
      : await ke();
    if (!a) throw m.provider.unauthorized("No owner account found");
    n.addSubAccount = {
      account: {
        type: "create",
        keys: [
          {
            type: a.address ? "address" : "webauthn-p256",
            publicKey: a.address || a.publicKey,
          },
        ],
      },
    };
...
function ar(e) {
  ...
  const r =
      (t = p.getState().account.accounts) === null || t === void 0
        ? void 0
        : t[0],
    i =
      (n = p.getState().account.chain) === null || n === void 0 ? void 0 : n.id,
    o =
      (a = p.getState().subAccount) === null || a === void 0
        ? void 0
        : a.address;
  if (!r || !o || !i)
    throw m.rpc.invalidParams(
  ...
  return {
    ...
    params: [{ account: r, chainId: O(i), spender: o }],
  };
}
function rr({ spendPermission: e, chainId: t }) {
  return {
    domain: {
      name: "Spend Permission Manager",
      version: "1",
      chainId: t,
      verifyingContract: dt,
    },
    types: {
      SpendPermission: [
...
function ir({ spendPermissionBatch: e, chainId: t }) {
  return {
    domain: {
      name: "Spend Permission Manager",
      version: "1",
...
async function Pt({ client: e, id: t }) {
  var n;
  const a = await nt(e, { id: t });
  if (a.status === "success")
    return (n = a.receipts) === null || n === void 0
      ? void 0
      : n[0].transactionHash;
  throw m.rpc.internal("failed to send transaction");
}
function Ot({ calls: e, from: t, chainId: n, capabilities: a }) {
  const r = ut.get().paymasterUrls;
  let i = {
  ...
  return r?.[n] && (i = oe(i, { paymasterService: { url: r?.[n] } })), i;
}
async function sr() {
  const e = Oe();
  return await new Promise((n) => {
    Pe({ dialogContext: "sub_account_insufficient_balance" }),
      e.presentItem({
        ...
        onClose: () => {
          bt({ dialogContext: "sub_account_insufficient_balance" }), e.clear();
        },
        actionItems: [
          {
...
function or({ errorData: e, sourceAddress: t }) {
  var n;
  const a = [];
  for (const [r, { amount: i, sources: o }] of Object.entries(
    (n = e?.required) !== null && n !== void 0 ? n : {}
  )) {
    if (
      o.filter(
        (s) =>
          ae(s.balance) >= ae(i) && s.address.toLowerCase() === t?.toLowerCase()
      ).length === 0
    )
      throw new Error("Source address has insufficient balance for a token");
    a.push({ token: r, requiredAmount: ae(i) });
  }
  return a;
}
function cr(e) {
...
function dr(e) {
  return Qt(Yt(Z(e)), 0, 16);
}
function lr({ attribution: e, dappOrigin: t }) {
  if (e) {
    if ("auto" in e && e.auto && t) return dr(t);
    if ("dataSuffix" in e) return e.dataSuffix;
  }
}
function pr(e, t) {
  var n;
  if (!Array.isArray(e?.params)) return !1;
  const a =
    (n = e.params[0]) === null || n === void 0 ? void 0 : n.capabilities;
  return !a || typeof a != "object" ? !1 : t in a;
}
function $(e, t) {
...
function ee(e, t) {
  return [...e.filter((a) => a !== t), t];
}
async function mr() {
  const e = p.spendPermissions.get(),
    t = p.subAccounts.get(),
...
function hr({ webauthn: e, signature: t, id: n }) {
  const a = et(t);
  return {
    id: n,
    rawId: te(Be(n)),
    response: {
      authenticatorData: te(ge(e.authenticatorData)),
      clientDataJSON: te(Be(e.clientDataJSON)),
      signature: te(gr(a.r, a.s)),
    },
...
async function vr(e) {
  const { owner: t, ownerIndex: n, address: a, client: r, factoryData: i } = e,
    o = { abi: Wt, address: Ht, version: "0.6" },
    c = { abi: lt, address: En };
  return qt({
    client: r,
    entryPoint: o,
    extend: { abi: N, factory: c },
    async decodeCalls(s) {
      const u = at({ abi: N, data: s });
      if (u.functionName === "execute")
        return [{ to: u.args[0], value: u.args[1], data: u.args[2] }];
      if (u.functionName === "executeBatch")
        return u.args[0].map((f) => ({
          to: f.target,
          value: f.value,
          data: f.data,
        }));
      throw new rt(`unable to decode calls for "${u.functionName}"`);
    },
    async encodeCalls(s) {
      var u, f;
      return s.length === 1
        ? B({
            ...
            args: [
              s[0].to,
              (u = s[0].value) !== null && u !== void 0 ? u : BigInt(0),
              (f = s[0].data) !== null && f !== void 0 ? f : "0x",
            ],
          })
        : B({
            abi: N,
            ...
            args: [
              s.map((h) => {
                var l, d;
                return {
                  data: (l = h.data) !== null && l !== void 0 ? l : "0x",
                  target: h.to,
                  value: (d = h.value) !== null && d !== void 0 ? d : BigInt(0),
                };
              }),
            ],
          });
    ...
    async getFactoryArgs() {
      return i
        ? { factory: c.address, factoryData: i }
        : { factory: c.address, factoryData: i };
    },
    ...
    async sign(s) {
      const u = await this.getAddress(),
        f = fe({ address: u, chainId: r.chain.id, hash: s.hash }),
        h = await ne({ hash: f, owner: t });
      return Q({ ownerIndex: n, signature: h });
    },
    async signMessage(s) {
      const { message: u } = s,
        f = await this.getAddress(),
        h = fe({ address: f, chainId: r.chain.id, hash: tt(u) }),
        l = await ne({ hash: h, owner: t });
      return Q({ ownerIndex: n, signature: l });
    },
    async signTypedData(s) {
      const { domain: u, types: f, primaryType: h, message: l } = s,
        d = await this.getAddress(),
        g = fe({
          address: d,
          chainId: r.chain.id,
          hash: Ce({ domain: u, message: l, primaryType: h, types: f }),
        }),
        b = await ne({ hash: g, owner: t });
      return Q({ ownerIndex: n, signature: b });
    },
    async signUserOperation(s) {
      const { chainId: u = r.chain.id } = s,
        f = br(s, ["chainId"]),
        h = await this.getAddress(),
        l = Zt({
          chainId: u,
          entryPointAddress: o.address,
          entryPointVersion: o.version,
          userOperation: Object.assign(Object.assign({}, f), { sender: h }),
        }),
        d = await ne({ hash: l, owner: t });
      return Q({ ownerIndex: n, signature: d });
    },
    userOperation: {
      async estimateGas(s) {
        var u;
        if (t.type === "webAuthn")
          return {
            verificationGasLimit: BigInt(
              Math.max(
                Number(
                  (u = s.verificationGasLimit) !== null && u !== void 0
                    ? u
                    : BigInt(0)
                ),
                8e5
...
async function ne({ hash: e, owner: t }) {
  if (t.type === "webAuthn") {
    const { signature: n, webauthn: a } = await t.sign({ hash: e });
    return yr({ signature: n, webauthn: a });
  }
  if (t.sign) return t.sign({ hash: e });
  throw new rt("`owner` does not support raw sign.");
}
function fe({ address: e, chainId: t, hash: n }) {
  return Ce({
    domain: {
      chainId: t,
...
function yr({ webauthn: e, signature: t }) {
  const { r: n, s: a } = et(t);
  return it(
    [
      {
...
function Q(e) {
  const { ownerIndex: t = 0 } = e,
    n = (() => {
      if (Xt(e.signature) !== 65) return e.signature;
      const a = Gt(e.signature);
      return _t(
        ["bytes32", "bytes32", "uint8"],
        [a.r, a.s, a.yParity === 0 ? 27 : 28]
      );
    })();
  return it(
    [
...
async function wr({
  ...
  var s;
  const u = { address: e, factory: n, factoryData: a },
    f = (s = t.chain) === null || s === void 0 ? void 0 : s.id;
  if (!f) throw m.rpc.internal("chainId not found");
  const h = await vr({
      owner: r,
      ownerIndex: i ?? 1,
      address: e,
      ...
      try {
        switch (d.method) {
          ...
          case "eth_sendTransaction": {
            U(d.params);
            const v = d.params[0];
            R(v.to, m.rpc.invalidParams("to is required"));
            const I = {
                to: v.to,
                data: we((g = v.data) !== null && g !== void 0 ? g : "0x", !0),
                value: we(
                  (b = v.value) !== null && b !== void 0 ? b : "0x",
                  !0
                ),
                from: (P = v.from) !== null && P !== void 0 ? P : u.address,
              },
              K = Ot({ calls: [I], chainId: f, from: I.from }),
              q = await l(K);
            return Pt({ client: t, id: q });
          }
          case "wallet_sendCalls": {
            U(d.params);
            const v = Y(d.params[0], "chainId");
            if (!v) throw m.rpc.invalidParams("chainId is required");
            if (!W(v))
              throw m.rpc.invalidParams(
                "chainId must be a hex encoded integer"
              );
            if (!d.params[0]) throw m.rpc.invalidParams("params are required");
            if (!("calls" in d.params[0]))
              throw m.rpc.invalidParams("calls are required");
            let I = {
              method: "wallet_prepareCalls",
              params: [
                {
                  version: "1.0",
                  calls: d.params[0].calls,
                  chainId: v,
                  from: u.address,
                  capabilities:
                    "capabilities" in d.params[0]
                      ? d.params[0].capabilities
                      : {},
                },
              ],
            };
            ...
            let K = await l(I);
            const q = await ((F = (T = r).sign) === null || F === void 0
              ? void 0
              : F.call(T, { hash: De(K.signatureRequest.hash) }));
            let de;
            if (!q) throw m.rpc.internal("signature not found");
            return (
              W(q)
                ? (de = {
                    type: "secp256k1",
                    data: { address: r.address, signature: q },
                  })
                : (de = {
                    type: "webauthn",
                    data: {
          ...
          case "wallet_prepareCalls": {
            ...
            if (!d.params[0]) throw m.rpc.invalidParams("params are required");
            if (!Y(d.params[0], "calls"))
              throw m.rpc.invalidParams("calls are required");
            const I = d.params[0];
            return (
              c &&
                I.capabilities &&
                !("attribution" in I.capabilities) &&
                (I.capabilities.attribution = c),
              await t.request({
                method: "wallet_prepareCalls",
                params: [
                  Object.assign(Object.assign({}, d.params[0]), { chainId: v }),
                ],
              })
            );
          }
          case "personal_sign": {
            if ((U(d.params), !W(d.params[0])))
              throw m.rpc.invalidParams("message must be a hex encoded string");
            const v = De(d.params[0]);
            return h.signMessage({ message: v });
          }
          case "eth_signTypedData_v4": {
            U(d.params);
            const v =
              typeof d.params[1] == "string"
                ? JSON.parse(d.params[1])
                : d.params[1];
            return h.signTypedData(v);
          }
          ...
          default:
            throw m.rpc.methodNotSupported();
        }
      } catch (v) {
        if (gt(v)) {
          const I = On(v);
...
async function jt({
  ...
  if (!(await en(t, { address: e })) && a && r) {
    const c = at({ abi: lt, data: r });
    if (c.functionName !== "createAccount")
      throw m.rpc.internal("unknown factory function");
    const [s] = c.args;
    return s.findIndex((u) => u.toLowerCase() === $e(n).toLowerCase());
  }
  const o = await Le(t, { address: e, abi: N, functionName: "ownerCount" });
  for (let c = Number(o) - 1; c >= 0; c--) {
    const s = await Le(t, {
      ...
      u = $e(n);
    if (s.toLowerCase() === u.toLowerCase()) return c;
  }
  return -1;
}
function $e(e) {
...
async function kr() {
  ...
  const n =
      (t =
        (e = p.config.get().metadata) === null || e === void 0
          ? void 0
          : e.appName) !== null && t !== void 0
        ? t
        : "App",
    a = Oe();
  return new Promise((r) => {
    Pe({ dialogContext: "sub_account_add_owner" }),
      a.presentItem({
        title: `Re-authorize ${n}`,
        message: `${n} has lost access to your account. Please sign at the next step to re-authorize ${n}`,
        onClose: () => {
          bt({ dialogContext: "sub_account_add_owner" }), r("cancel");
        },
        actionItems: [
          {
            text: "Continue",
...
async function Ar({ ownerAccount: e, globalAccountRequest: t }) {
  var n, a;
  const r = p.account.get(),
    i = p.subAccounts.get(),
    o =
      (n = r.accounts) === null || n === void 0
        ? void 0
        : n.find((g) => g.toLowerCase() !== i?.address.toLowerCase());
  R(o, m.provider.unauthorized("no global account")),
    R(
      (a = r.chain) === null || a === void 0 ? void 0 : a.id,
      m.provider.unauthorized("no chain id")
    ),
    R(i?.address, m.provider.unauthorized("no sub account"));
  const c = [];
  if (
    (e.type === "local" &&
      e.address &&
      c.push({
        to: i.address,
        data: B({ abi: N, functionName: "addOwnerAddress", args: [e.address] }),
        value: Z(0),
      }),
    e.publicKey)
  ) {
    const [g, b] = st([{ type: "bytes32" }, { type: "bytes32" }], e.publicKey);
    c.push({
      to: i.address,
      data: B({ abi: N, functionName: "addOwnerPublicKey", args: [g, b] }),
      value: Z(0),
    });
  }
  const s = {
    method: "wallet_sendCalls",
    params: [{ version: "1", calls: c, chainId: O(84532), from: o }],
  };
  if ((await kr()) === "cancel")
    throw m.provider.unauthorized("user cancelled");
  const f = await t(s),
    h = xt(r.chain.id);
  if (
    (R(h, m.rpc.internal(`client not found for chainId ${r.chain.id}`)),
    (await nt(h, { id: f })).status !== "success")
  )
    throw m.rpc.internal("add owner call failed");
  const d = await jt({
    address: i.address,
    publicKey: e.type === "local" && e.address ? e.address : e.publicKey,
    client: h,
  });
  if (d === -1) throw m.rpc.internal("failed to find owner index");
  return d;
}
async function Sr({
  errorData: e,
  ...
  request: r,
  subAccountRequest: i,
  globalAccountRequest: o,
}) {
  var c;
  const s = (c = a.chain) === null || c === void 0 ? void 0 : c.id;
  R(s, m.rpc.internal("invalid chainId"));
  const u = or({ errorData: e, sourceAddress: t }),
    f = await sr();
  if (f === "cancel") throw new Error("User cancelled funding");
  let h;
  const l = 60 * 60 * 24,
    d = 3;
  if (f === "update_permission") {
    if (u.length === 1) {
      const C = u[0],
        v = rr({
          spendPermission: {
            token: C.token,
            allowance: O(C.requiredAmount * BigInt(d)),
            period: l,
            account: t,
            spender: n,
            start: 0,
      ...
      h = { method: "eth_signTypedData_v4", params: [t, v] };
    } else {
      const C = ir({
        spendPermissionBatch: {
          account: t,
          ...
          permissions: u.map((v) => ({
            token: v.token,
            allowance: O(v.requiredAmount * BigInt(d)),
            period: l,
            account: t,
            spender: n,
            salt: "0x0",
      ...
      h = { method: "eth_signTypedData_v4", params: [t, C] };
    }
    try {
      await o(h);
    } catch (C) {
      throw (
        (console.error(C), new Error("User denied spend permission request"))
      );
    }
    return i(r);
  }
  const g = u.map((C) =>
    ...
    "0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE".toLowerCase()
      ? { to: n, value: O(C.requiredAmount), data: "0x" }
      : {
          to: C.token,
          value: "0x0",
          data: B({
            ...
            args: [n, C.requiredAmount],
          }),
        }
  );
  let b;
  if (r.method === "wallet_sendCalls" && cr(r.params)) b = r.params[0];
  else if (r.method === "eth_sendTransaction" && ur(r.params))
    b = Ot({ calls: [r.params[0]], chainId: s, from: r.params[0].from })
      .params[0];
  ...
  const P = B({
      ...
      args: [
        b.calls.map((C) => {
          ...
          return {
            target: C.to,
            value: ae((v = C.value) !== null && v !== void 0 ? v : "0x0"),
            data: (I = C.data) !== null && I !== void 0 ? I : "0x",
          };
        }),
      ],
    }),
    T = [...g, { data: P, to: n, value: "0x0" }],
    F = await o({
      method: "wallet_sendCalls",
      params: [Object.assign(Object.assign({}, b), { calls: T, from: t })],
    });
  return r.method === "eth_sendTransaction" ? Pt({ client: a, id: F }) : F;
}
class xr {
  constructor(t) {
    var n, a, r, i;
    (this.communicator = t.communicator),
      ...
      (this.keyManager = new $a());
    const { account: o, chains: c } = p.getState();
    (this.accounts = (n = o.accounts) !== null && n !== void 0 ? n : []),
      (this.chain =
        (a = o.chain) !== null && a !== void 0
          ? a
          : {
              id:
                (i =
                  (r = t.metadata.appChainIds) === null || r === void 0
                    ? void 0
                    : r[0]) !== null && i !== void 0
                  ? i
                  : 1,
  ...
  async handshake(t) {
    var n, a, r;
    const i = M.get(t);
    ka({ method: t.method, correlationId: i });
    try {
      await ((a = (n = this.communicator).waitForPopupLoaded) === null ||
      a === void 0
        ? void 0
        : a.call(n));
      const o = await this.createRequestMessage(
          {
            handshake: {
              method: t.method,
              params: (r = t.params) !== null && r !== void 0 ? r : [],
            },
          },
          i
        ),
        c = await this.communicator.postRequestAndWaitForResponse(o);
      if ("failure" in c.content) throw c.content.failure;
      const s = await Tt("public", c.sender);
      await this.keyManager.setPeerPublicKey(s);
      const u = await this.decryptResponseMessage(c);
      this.handleResponse(t, u), Sa({ method: t.method, correlationId: i });
    } catch (o) {
      throw (Aa({ method: t.method, correlationId: i, errorMessage: J(o) }), o);
    }
  }
  async request(t) {
    const n = M.get(t);
    xa({ method: t.method, correlationId: n });
    try {
      const a = await this._request(t);
      return Ca({ method: t.method, correlationId: n }), a;
    } catch (a) {
      throw (Ea({ method: t.method, correlationId: n, errorMessage: J(a) }), a);
    }
  }
  async _request(t) {
    var n, a, r, i, o, c, s, u, f, h;
    if (this.accounts.length === 0)
      switch (t.method) {
        case "wallet_switchEthereumChain": {
          _e(t.params), (this.chain.id = Number(t.params[0].chainId));
          return;
        }
        case "wallet_connect": {
          await ((a = (n = this.communicator).waitForPopupLoaded) === null ||
          ...
          pr(t, "addSubAccount") &&
            (l =
              (i =
                (r = p.subAccountsConfig.get()) === null || r === void 0
                  ? void 0
                  : r.capabilities) !== null && i !== void 0
                ? i
                : {});
          const d = oe(t, l);
          return this.sendRequestToPopup(d);
        }
        case "wallet_sendCalls":
        case "wallet_sign":
    ...
    if (this.shouldRequestUseSubAccountSigner(t)) {
      const l = M.get(t);
      Ta({ method: t.method, correlationId: l });
      try {
        const d = await this.sendRequestToSubAccountSigner(t);
        return Ia({ method: t.method, correlationId: l }), d;
      } catch (d) {
        throw (
          (Pa({ method: t.method, correlationId: l, errorMessage: J(d) }), d)
        );
      }
    }
    switch (t.method) {
      ...
      case "eth_accounts": {
        const l = p.subAccounts.get(),
          d = p.subAccountsConfig.get();
        return (
          l?.address &&
            (this.accounts = d?.enableAutoSubAccounts
              ? $(this.accounts, l.address)
              : ee(this.accounts, l.address)),
          (o = this.callback) === null ||
            o === void 0 ||
            o.call(this, "connect", { chainId: O(this.chain.id) }),
          this.accounts
        );
      }
      case "eth_coinbase":
      ...
      case "wallet_connect": {
        const l = await mr();
        if (l) return l;
        await ((s = (c = this.communicator).waitForPopupLoaded) === null ||
        s === void 0
          ? void 0
          : s.call(c)),
          await Ae();
        const d = p.subAccountsConfig.get(),
          g = oe(t, (u = d?.capabilities) !== null && u !== void 0 ? u : {}),
          b = await this.sendRequestToPopup(g);
        return (
          (f = this.callback) === null ||
            f === void 0 ||
            f.call(this, "connect", { chainId: O(this.chain.id) }),
          b
        );
      }
      case "wallet_getSubAccounts": {
        const l = p.subAccounts.get();
        if (l?.address) return { subAccounts: [l] };
        if (!this.chain.rpcUrl)
          throw m.rpc.internal("No RPC URL set for chain");
        const d = await re(t, this.chain.rpcUrl);
        if ((U(d.subAccounts, "subAccounts"), d.subAccounts.length > 0)) {
          _(d.subAccounts[0]);
          const g = d.subAccounts[0];
          p.subAccounts.set({
            address: g.address,
            factory: g.factory,
            factoryData: g.factoryData,
          });
        }
        return d;
      }
      ...
      case "coinbase_fetchPermissions": {
        ...
        const l = ar(t),
          d = await re(l, ct),
          g = le(
            (h = l.params) === null || h === void 0 ? void 0 : h[0].chainId
          );
        return (
          p.spendPermissions.set(
            d.permissions.map((b) =>
              Object.assign(Object.assign({}, b), { chainId: g })
            )
          ),
          d
        );
  ...
  async sendRequestToPopup(t) {
    ...
    a === void 0
      ? void 0
      : a.call(n));
    const r = await this.sendEncryptedRequest(t),
      i = await this.decryptResponseMessage(r);
  ...
  async handleResponse(t, n) {
    ...
    switch (t.method) {
      case "eth_requestAccounts": {
        const u = s.value;
        (this.accounts = u),
          p.account.set({ accounts: u, chain: this.chain }),
          (a = this.callback) === null ||
            a === void 0 ||
            a.call(this, "accountsChanged", u);
        break;
      }
      case "wallet_connect": {
        const u = s.value,
          f = u.accounts.map((T) => T.address);
        (this.accounts = f), p.account.set({ accounts: f });
        const h = u.accounts.at(0),
          l = h?.capabilities;
        if (l?.subAccounts) {
          const T = l?.subAccounts;
          U(T, "subAccounts"),
            _(T[0]),
            p.subAccounts.set({
              address: T[0].address,
              factory: T[0].factory,
              factoryData: T[0].factoryData,
            });
        }
        let d = [this.accounts[0]];
        const g = p.subAccounts.get(),
          b = p.subAccountsConfig.get();
        g?.address &&
          (this.accounts = b?.enableAutoSubAccounts
            ? $(this.accounts, g.address)
            : ee(this.accounts, g.address));
        const P =
          (i =
            (r = u?.accounts) === null || r === void 0
              ? void 0
              : r[0].capabilities) === null || i === void 0
            ? void 0
            : i.spendPermissions;
        P && "permissions" in P && p.spendPermissions.set(P?.permissions),
          (o = this.callback) === null ||
            o === void 0 ||
            o.call(this, "accountsChanged", d);
        break;
      }
      case "wallet_addSubAccount": {
        _(s.value);
        const u = s.value;
        p.subAccounts.set(u);
        const f = p.subAccountsConfig.get();
        (this.accounts = f?.enableAutoSubAccounts
          ? $(this.accounts, u.address)
          : ee(this.accounts, u.address)),
          (c = this.callback) === null ||
            c === void 0 ||
            c.call(this, "accountsChanged", this.accounts);
        break;
      }
    }
    return s.value;
  ...
  async cleanup() {
    ...
    await this.keyManager.clear(),
      ...
      (this.chain = {
        id:
          (n =
            (t = a?.appChainIds) === null || t === void 0 ? void 0 : t[0]) !==
            null && n !== void 0
            ? n
            : 1,
      });
  ...
  async handleSwitchChainRequest(t) {
    _e(t.params);
    const n = wa(t.params[0].chainId);
    if (this.updateChain(n)) return null;
    const r = await this.sendRequestToPopup(t);
    return r === null && this.updateChain(n), r;
  }
  async handleGetCapabilitiesRequest(t) {
    tr(t.params);
    const n = t.params[0],
      a = t.params[1];
    if (!this.accounts.some((c) => an(c, n)))
      throw m.provider.unauthorized(
        "no active account found when getting capabilities"
      );
    const r = p.getState().account.capabilities;
    if (!r) return {};
    if (!a || a.length === 0) return r;
    const i = new Set(a.map((c) => le(c)));
    return Object.fromEntries(
      Object.entries(r).filter(([c]) => {
        try {
          const s = le(c);
          return i.has(s);
        } catch {
  ...
  async sendEncryptedRequest(t) {
    ...
    const a = await Fa({ action: t, chainId: this.chain.id }, n),
      r = M.get(t),
      i = await this.createRequestMessage({ encrypted: a }, r);
    return this.communicator.postRequestAndWaitForResponse(i);
  }
  async createRequestMessage(t, n) {
    const a = await Ct("public", await this.keyManager.getOwnPublicKey());
    return {
      id: crypto.randomUUID(),
      correlationId: n,
      sender: a,
  ...
  async decryptResponseMessage(t) {
    ...
    const c = await qa(i.encrypted, o),
      s = (n = c.data) === null || n === void 0 ? void 0 : n.chains;
    if (s) {
      const f =
          (a = c.data) === null || a === void 0 ? void 0 : a.nativeCurrencies,
        h = Object.entries(s).map(([l, d]) => {
          const g = f?.[Number(l)];
          return Object.assign(
            { id: Number(l), rpcUrl: d },
            g ? { nativeCurrency: g } : {}
          );
        });
      p.chains.set(h), this.updateChain(this.chain.id, h), Je(h);
    }
    const u = (r = c.data) === null || r === void 0 ? void 0 : r.capabilities;
    return u && p.account.set({ capabilities: u }), c;
  }
  updateChain(t, n) {
    var a;
    const r = p.getState(),
    ...
    return o
      ? (o !== this.chain &&
          ((this.chain = o),
          p.account.set({ chain: o }),
          (a = this.callback) === null ||
            a === void 0 ||
            a.call(this, "chainChanged", kt(o.id))),
        !0)
      : !1;
  }
  async addSubAccount(t) {
    var n, a, r, i;
    const c = p.getState().subAccount,
      s = p.subAccountsConfig.get();
    if (c?.address)
      return (
        (this.accounts = s?.enableAutoSubAccounts
          ? $(this.accounts, c.address)
          : ee(this.accounts, c.address)),
    ...
    if (
      (await ((r = (a = this.communicator).waitForPopupLoaded) === null ||
      r === void 0
        ? void 0
        : r.call(a)),
      ...
      if (t.params[0].account.keys && t.params[0].account.keys.length > 0)
        f = t.params[0].account.keys;
      else {
        const h =
            (i = p.subAccountsConfig.get()) !== null && i !== void 0 ? i : {},
          { account: l } = h.toOwnerAccount
  ...
  shouldRequestUseSubAccountSigner(t) {
    const n = Ge(t),
      a = p.subAccounts.get();
    return n ? n.toLowerCase() === a?.address.toLowerCase() : !1;
  }
  async sendRequestToSubAccountSigner(t) {
    var n;
    const a = p.subAccounts.get(),
      r = p.subAccountsConfig.get(),
      i = p.config.get();
    R(
      a?.address,
      m.provider.unauthorized(
        "no active sub account when sending request to sub account signer"
      )
    );
    const o = r?.toOwnerAccount ? await r.toOwnerAccount() : await ke();
    R(
      o?.account,
      m.provider.unauthorized(
      ...
      Ge(t) === void 0 && (t = er(t, a.address));
    const s = xt(this.chain.id);
    R(
      s,
      m.rpc.internal(
    ...
    const u = this.accounts.find(
      (g) => g.toLowerCase() !== a.address.toLowerCase()
    );
    R(
      u,
      m.provider.unauthorized(
    ...
    const f = lr({
      ...
      h = o.account.type === "local" ? o.account.address : o.account.publicKey;
    let l = await jt({
      address: a.address,
      factory: a.factory,
    ...
    if (l === -1) {
      const g = M.get(t);
      Oa({ method: t.method, correlationId: g });
      try {
        (l = await Ar({
          ownerAccount: o.account,
          globalAccountRequest: this.sendRequestToPopup.bind(this),
        })),
          ja({ method: t.method, correlationId: g });
      } catch (b) {
        return (
          Ra({ method: t.method, correlationId: g, errorMessage: J(b) }),
          m.provider.unauthorized(
    ...
    try {
      ...
      let b;
      if (gt(g)) b = JSON.parse(g.details);
      else if (He(g)) b = g;
      else throw g;
      if (!(He(b) && b.data) || !b.data) throw g;
      const P = M.get(t);
      Na({ method: t.method, correlationId: P });
      try {
        const T = await Sr({
          errorData: b.data,
          globalAccountAddress: u,
          subAccountAddress: a.address,
          client: s,
          request: t,
          subAccountRequest: d,
          globalAccountRequest: this.request.bind(this),
        });
        return Ma({ method: t.method, correlationId: P }), T;
      } catch (T) {
        throw (
          (console.error(T),
          Ua({ method: t.method, correlationId: P, errorMessage: J(T) }),
          g)
        );
      }
    }
...
class Cr extends ua {
  constructor(t) {
    ...
    super(),
      ...
      (this.communicator = new ia({ url: r, metadata: n, preference: i })),
      (this.signer = new xr({
        metadata: n,
  ...
  async request(t) {
    ...
    M.set(t, n), da({ method: t.method, correlationId: n });
    try {
      const a = await this._request(t);
      return pa({ method: t.method, correlationId: n }), a;
    } catch (a) {
      throw (
        (la({
          method: t.method,
  ...
  async _request(t) {
    var n, a;
    try {
      if ((Ha(t), !this.signer.isConnected))
        switch (t.method) {
          case "eth_requestAccounts": {
      ...
      const { code: i } = r;
      return (
        i === x.provider.unauthorized && (await this.disconnect()),
        Promise.reject(sa(r))
      );
    }
  }
...
const Tr = "isCoinbaseBrowser";
function Ir() {
  var e, t;
  const n =
    (e = window.ethereum) !== null && e !== void 0
      ? e
      : (t = window.top) === null || t === void 0
      ? void 0
      : t.ethereum;
  return n?.[Tr] ? n : null;
}
function Rr(e) {
  ...
  !((n = e.subAccounts) === null || n === void 0) &&
    n.toOwnerAccount &&
    We(e.subAccounts.toOwnerAccount),
    ...
    Nn(),
    Un(i.preference),
    i.preference.telemetry !== !1 && Sn();
  let o = null;
  const c = {
    getProvider: () => {
      var s;
      return o || (o = (s = Ir()) !== null && s !== void 0 ? s : new Cr(i)), o;
    },
    subAccount: {
      async create(s) {
        var u;
        return await ((u = c.getProvider()) === null || u === void 0
          ? void 0
          : u.request({
              method: "wallet_addSubAccount",
              params: [{ version: "1", account: s }],
            }));
      },
      async get() {
        var s, u;
        const f = p.subAccounts.get();
        if (f?.address) return f;
        const l =
          (u = (
            await ((s = c.getProvider()) === null || s === void 0
              ? void 0
              : s.request({
                  method: "wallet_connect",
      ...
      addOwner: async ({ address: s, publicKey: u, chainId: f }) => {
        var h, l;
        const d = p.subAccounts.get(),
          g = p.account.get();
        R(g, new Error("account does not exist")),
          R(d?.address, new Error("subaccount does not exist"));
        const b = [];
        if (u) {
          const [P, T] = st([{ type: "bytes32" }, { type: "bytes32" }], u);
          b.push({
            to: d.address,
            data: B({
              abi: N,
        ...
        return (
          s &&
            b.push({
              to: d.address,
              data: B({ abi: N, functionName: "addOwnerAddress", args: [s] }),
              value: Z(0),
            }),
          await ((h = c.getProvider()) === null || h === void 0
            ? void 0
            : h.request({
                method: "wallet_sendCalls",
                params: [
                  {
                    ...
                    chainId: Z(f),
                    from:
                      (l = g.accounts) === null || l === void 0 ? void 0 : l[0],
                    version: "1",
                  },
                ],
              }))
      ...
      setToOwnerAccount(s) {
        We(s), p.subAccountsConfig.set({ toOwnerAccount: s });
      },
    },
  };
  return c;
}
export { Rr as createBaseAccountSDK, ke as getCryptoKeyAccount };
//# sourceMappingURL=index-BFj-pj0y.js.map
