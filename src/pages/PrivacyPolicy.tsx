        ...
        <article className="max-w-4xl mx-auto prose prose-slate dark:prose-invert">
          <header>
            ...
            <p className="text-foreground mt-4">
              Bask respects your privacy and values transparency. This policy explains what data we collect, how we use it, and your rights.
            </p>
          </header>
          ...
          <section>
            ...
            <p className="mt-4">Bask never collects private keys or seed phrases.</p>

            <h3 className="text-2xl font-semibold mt-8 mb-4">2. How We Use Your Data</h3>
            <p>
              We use collected data to operate and improve Bask, provide support and notifications, analyze platform activity, and prevent abuse or fraud. Bask does not sell or rent personal data to third parties.
            </p>

            <h3 className="text-2xl font-semibold mt-8 mb-4">3. Third-Party Services</h3>
            <p>Bask uses several trusted third-party providers:</p>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <p className="mt-4">
              These providers process data under their own privacy policies. Bask is not responsible for how they handle information.
            </p>

            <h3 className="text-2xl font-semibold mt-8 mb-4">4. Cookies</h3>
            <p>
              Bask uses cookies for essential session management, analytics, and security. You can disable cookies in your browser settings, but some platform features may stop working properly.
            </p>

            <h3 className="text-2xl font-semibold mt-8 mb-4">5. Data Retention</h3>
            <p>
              Bask retains wallet and email data as long as your account is active. Analytics data may be kept for up to 24 months. You can request data deletion by emailing <a href="mailto:privacy@entrave.com" className="text-primary hover:underline">privacy@entrave.com</a> (subject to blockchain immutability limits).
            </p>
            ...
            <p>
              Bask uses HTTPS, Supabase encryption, and secure infrastructure to protect data. However, no online service is completely secure. You use Bask at your own risk.
            </p>

            <h3 className="text-2xl font-semibold mt-8 mb-4">8. Children's Privacy</h3>
            <p>
              Bask is not intended for users under 18 years old. If we discover that we have collected information from minors, we will delete it promptly.
            </p>

            <h3 className="text-2xl font-semibold mt-8 mb-4">9. Changes to This Policy</h3>
            <p>
              Bask may update this Privacy Policy periodically. The updated version will be published on entrave.com/privacy with a new revision date.
            </p>
            ...
            <div className="mt-8 p-4 bg-secondary/30 rounded-lg">
              <p className="text-sm">
                By using Bask, you also agree to our <Link to="/terms-of-service" className="text-primary hover:underline font-medium">Terms of Service</Link>.
              </p>
            </div>
          </section>
        </article>
